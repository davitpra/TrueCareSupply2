    ...
    <section className={styles.hero} role="banner">
      ...
      <div className={styles.heroContent}>
        <div className={styles.heroText}>
          <h1>
            L&apos;excellence <span className={styles.highlight}>médicale</span>{" "}
            commence ici
          </h1>
          <p className={styles.heroSubtitle}>
            Le partenaire stratégique n°1 pour l&apos;approvisionnement médical
            au Québec. Zéro rupture, livraison garantie, excellence absolue.
          </p>
          ...
          >
            ...
            <a
              ...
              aria-label="Explorer nos services médicaux"
            >
          ...
          <div className={styles.heroCards}>
            <div className={styles.floatingCard}>
              <div
                ...
                aria-label="Taux de disponibilité de 99.9 pourcent"
              >
                99.9%
              </div>
            ...
            <div className={styles.floatingCard}>
              <div
                className={styles.cardStat}
                aria-label="Livraison en 24 heures"
              >
                24h
              </div>
